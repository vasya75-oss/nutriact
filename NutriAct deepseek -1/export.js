async function renderProfile(container) {
    ...
    container.innerHTML = `
        <div class="page">
            ...
            <div class="card">
                ...
                <label>Deepseek API Key: <input type="text" id="deepseekApiKey" value="${settings.deepseekApiKey || ''}" style="width:100%"></label><br>
    ...
    document.getElementById('saveGoalsBtn').addEventListener('click', async () => {
        await saveUserSettings({
            ...
            dailyWaterGoal: parseFloat(document.getElementById('dailyWaterGoal').value)
        });
    ...
    document.getElementById('saveApiBtn').addEventListener('click', async () => {
        ...
        await saveUserSettings({ supabaseUrl, supabaseAnonKey, deepseekApiKey });
